...
const (
	EmailService_SendOrderConfirmation_FullMethodName = "/ecommerce.email.EmailService/SendOrderConfirmation"
)
...
type EmailServiceClient interface {
	// Confirm a mock payment/order confirmation email was sent.
	SendOrderConfirmation(ctx context.Context, in *SendOrderConfirmationRequest, opts ...grpc.CallOption) (*SendResponse, error)
}
...
func (c *emailServiceClient) SendOrderConfirmation(ctx context.Context, in *SendOrderConfirmationRequest, opts ...grpc.CallOption) (*SendResponse, error) {
...
type EmailServiceServer interface {
	// Confirm a mock payment/order confirmation email was sent.
	SendOrderConfirmation(context.Context, *SendOrderConfirmationRequest) (*SendResponse, error)
...
func (UnimplementedEmailServiceServer) SendOrderConfirmation(context.Context, *SendOrderConfirmationRequest) (*SendResponse, error) {
...
var EmailService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ecommerce.email.EmailService",
