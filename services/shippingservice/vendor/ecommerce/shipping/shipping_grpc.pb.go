...
const (
	ShippingService_GetQuote_FullMethodName  = "/ecommerce.shipping.ShippingService/GetQuote"
	ShippingService_ShipOrder_FullMethodName = "/ecommerce.shipping.ShippingService/ShipOrder"
)
...
var ShippingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ecommerce.shipping.ShippingService",
