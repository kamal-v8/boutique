...
const (
	UserService_Register_FullMethodName       = "/ecommerce.user.UserService/Register"
	UserService_Login_FullMethodName          = "/ecommerce.user.UserService/Login"
	UserService_Refresh_FullMethodName        = "/ecommerce.user.UserService/Refresh"
	UserService_Logout_FullMethodName         = "/ecommerce.user.UserService/Logout"
	UserService_GetUser_FullMethodName        = "/ecommerce.user.UserService/GetUser"
	UserService_GetUserByEmail_FullMethodName = "/ecommerce.user.UserService/GetUserByEmail"
	UserService_ValidateToken_FullMethodName  = "/ecommerce.user.UserService/ValidateToken"
)
...
func (c *userServiceClient) Logout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*common.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServiceServer) Logout(context.Context, *LogoutRequest) (*common.Empty, error) {
